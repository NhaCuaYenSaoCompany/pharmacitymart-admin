/**
 * Bảng ánh xạ các ký tự tiếng Việt có dấu sang không dấu
 */
 ...
 * @example
 * ```typescript
 * generateSlug("Xin chào thế giới") // "xin-chao-the-gioi"
 * generateSlug("Hôm nay trời đẹp!!!") // "hom-nay-troi-dep"
 * ```
 */
export function generateSlug(text: string): string {
  ...
  return text
    ...
    .replace(/^-+|-+$/g, "")
    // Thay nhiều dấu gạch ngang liên tiếp bằng một dấu
    .replace(/-+/g, "-");
}
